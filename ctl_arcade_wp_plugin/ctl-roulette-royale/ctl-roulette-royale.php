<?php
    /*
    Plugin Name: CTL Arcade - Roulette Royale
    Plugin URI: http://www.codethislab.com/
    Description: Roulette Royale for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeRouletteRoyale {

        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-roulette-royale";
        private $_szPluginName              = "Roulette Royale";
        private $_szAspectRatio             = "5:3";
    ...
    $g_oCTLArcadeRouletteRoyale =  new CTLArcadeRouletteRoyale();
